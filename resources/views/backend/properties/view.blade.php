        ...
        <div class="content-body">
			...
			<div class="container-fluid">
                <div class="form-head page-titles d-flex  align-items-center">
					...
					<a href="{{ route('properties.delete', $property->id)}}" class="btn btn-danger rounded me-3" style="background-color: #fff;color: #FF6746;"><i class="las la-trash" style="color: #FF6746;"></i>Delete</a>
				</div>
				<div class="row">
						...
						<div class="row">
							...
							<div class="col-xl-12">
								<div class="card property-features">
									...
									<div class="card-body">
										<ul>
											<li>Year Built: {{ $property->year }}</li>
							...
							<div class="col-xl-12">
								<div class="card property-features">
									<div class="card-header border-0 pb-0">	
										<h3 class="fs-20 text-black mb-0">Property Status</h3>
									</div>
									<div class="card-body">
										<ul>
										@foreach(json_decode($property->status) as $status)
                                            <li>{{ $status }}</li>
                                        @endforeach
										</ul>
									</div>
										...
										<div>
											...
											<div class="d-md-flex d-block mb-sm-5 mb-3">
												<div class="me-auto mb-md-0 mb-4">
													<h2 class="font-w600 text-black">{{ $property->name }}</h2>
													<span class="fs-18">
												...
												<div class="ms-md-4 text-md-right">
													...
													<h4 class="fs-24 text-primary"> N{{ $property->price }}</h4>
												</div>
											</div>
								...
								<div class="card property-features">
									...
									<div class="card-body">
										...
										@foreach(json_decode($property->features) as $feature)
											<li><i class="las la-check-circle" style="color: #FF6600;"></i>{{ $feature }}</li>
                                        @endforeach
										</ul>
									</div>
								</div>
